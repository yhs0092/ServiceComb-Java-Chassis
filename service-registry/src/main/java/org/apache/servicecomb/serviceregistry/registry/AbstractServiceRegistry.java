...
public abstract class AbstractServiceRegistry implements ServiceRegistry {
  ...
  private void initRevisionCache() {
    revisionCache = CacheBuilder.newBuilder()
        .expireAfterAccess(serviceRegistryConfig.getInstancePullInterval() + 300, TimeUnit.SECONDS)
  ...
  /**
   * Cache the revision value of different services.
   * The key of the revision cache is generated by {@link #generateRevisionKey(String, String, String)}.
   */
  private LoadingCache<String, String> revisionCache;
  ...
  private String generateRevisionKey(String appId, String microserviceName, String versionRule) {
    return appId + "-" + microserviceName + "-" + versionRule;
  }
}
