...
public abstract class AbstractClientPool implements ClientPool {
  ...
  public AbstractClientPool(HttpClientOptions httpClientOptions) {
  ...
  private HttpClientOptions getOrCreateHttpClientOptions() {
    if (null == httpClientOptions) {
  ...
  public void create() {
    ...
    HttpClientOptions httpClientOptions = getOrCreateHttpClientOptions();
